...
## The original assumption: “More context is always better”
...
> **The model wasn’t actually using most of that context.**
...
We kept RAG — but only where it adds real value.
...
The system stopped feeling “heavy”.
...
> *“Use this only if the decision cannot progress without it.”*
...
> It’s the one that knows when reading is unnecessary.**

---

👉 **In the next article**, I’ll explore how  
**Human-in-the-Loop evolved from a fallback mechanism into a governance layer — and why that distinction matters.**
